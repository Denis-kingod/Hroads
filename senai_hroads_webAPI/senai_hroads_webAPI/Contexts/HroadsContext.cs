...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-404RQHFB\\SQLEXPRESS; initial catalog=HROADS; user Id=sa; pwd=Alexandre2002;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Class>(entity =>
            {
                entity.HasKey(e => e.IdClasses)
                    .HasName("PK__Classes__5701067284206C5C");

                entity.HasIndex(e => e.NomeClasse, "UQ__Classes__F1ED8102F5FF15DC")
                    .IsUnique();
            ...
            modelBuilder.Entity<HabClass>(entity =>
            {
                entity.HasKey(e => e.IdHabClasses)
                    .HasName("PK__HabClass__2D0E77F92D3F563A");
            ...
            modelBuilder.Entity<Habilidade>(entity =>
            {
                entity.HasKey(e => e.IdHabilidade)
                    .HasName("PK__Habilida__655F752824710607");

                entity.HasIndex(e => e.NomeHabilidade, "UQ__Habilida__08EF5E0C68A0EA7A")
                    .IsUnique();
            ...
            modelBuilder.Entity<Personagem>(entity =>
            {
                entity.HasKey(e => e.IdPersonagem)
                    .HasName("PK__Personag__E175C72ED1E4B992");
            ...
            modelBuilder.Entity<TipoHabilidade>(entity =>
            {
                entity.HasKey(e => e.IdTipoHabilidade)
                    .HasName("PK__TipoHabi__B197B832031487B5");
            ...
            modelBuilder.Entity<TipoUsuario>(entity =>
            {
                entity.HasKey(e => e.IdTipoUsuario)
                    .HasName("PK__TipoUsua__03006BFFD4B9313E");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__Usuario__645723A6C5F13673");
